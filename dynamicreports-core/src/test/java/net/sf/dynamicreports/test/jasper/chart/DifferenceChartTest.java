...
public class DifferenceChartTest extends AbstractJasperChartTest implements Serializable {
  ...
  public void test() {
    ...
    Assertions.assertEquals(Color.BLUE,
        ((XYDifferenceRenderer) renderer).getPositivePaint(), "positive paint");
    Assertions.assertEquals(Color.MAGENTA,
        ((XYDifferenceRenderer) renderer).getNegativePaint(), "negative paint");
