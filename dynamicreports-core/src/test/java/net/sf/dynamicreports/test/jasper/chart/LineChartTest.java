...
public class LineChartTest extends AbstractJasperChartTest implements Serializable {
  ...
  public void test() {
    ...
    Assertions.assertFalse(((LineAndShapeRenderer) renderer).getBaseShapesVisible(), "show shapes");
    Assertions.assertFalse(((LineAndShapeRenderer) renderer).getBaseLinesVisible(),"show lines");
