...
public class CrosstabTest extends AbstractJasperTest {
    ...
    public void test() {
        ...
        Assertions.assertEquals(100, crosstab.getColumnBreakOffset(), "Crosstab columnBreakOffset");
        Assertions.assertTrue(crosstab.getIgnoreWidth(), "Crosstab ignoreWidth");
        Assertions.assertEquals(RunDirectionEnum.RTL, crosstab.getRunDirectionValue(), "Crosstab runDirection");
        Assertions.assertEquals(CrosstabRowPositionEnum.STRETCH, crosstab.getRowGroups()[0].getPositionValue(), "Crosstab row group position");
        Assertions.assertEquals(CrosstabColumnPositionEnum.STRETCH, crosstab.getColumnGroups()[0].getPositionValue(), "Crosstab column group position");
    }
}
