...
public class XyBlockChartTest extends AbstractJasperChartTest {
  ...
  public void test() {
    ...
    Assertions.assertEquals(org.jfree.ui.RectangleAnchor.BOTTOM_LEFT,
        ((XYBlockRenderer) renderer).getBlockAnchor(), "block anchor");

    Assertions.assertEquals(LookupPaintScale.class,
        ((XYBlockRenderer) renderer).getPaintScale().getClass(), "paintScale");
