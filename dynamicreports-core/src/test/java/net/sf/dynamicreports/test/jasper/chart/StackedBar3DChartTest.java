...
public class StackedBar3DChartTest extends AbstractJasperChartTest implements Serializable {
  ...
  public void test() {
    ...
    Assertions.assertEquals(StackedBarRenderer3D.class,
        categoryPlot.getRenderer().getClass(), "renderer");
    final BarRenderer3D renderer = (BarRenderer3D) categoryPlot.getRenderer();
    Assertions.assertTrue(renderer.getBaseItemLabelsVisible(), "show labels");
