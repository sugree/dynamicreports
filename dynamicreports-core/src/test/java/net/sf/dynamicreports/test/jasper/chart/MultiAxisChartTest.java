...
public class MultiAxisChartTest extends AbstractJasperChartTest implements Serializable {
    ...
    public void test() {
        ...
        Assertions.assertEquals(AxisPositionEnum.LEFT_OR_TOP, chartAxis.getPositionValue(), "position");
        Assertions.assertEquals(JRChart.CHART_TYPE_TIMESERIES, chartAxis.getChart().getChartType(), "chart");
        chartAxis = multiAxisPlot.getAxes().get(1);
        Assertions.assertEquals(AxisPositionEnum.RIGHT_OR_BOTTOM, chartAxis.getPositionValue(), "position");
        Assertions.assertEquals(JRChart.CHART_TYPE_TIMESERIES, chartAxis.getChart().getChartType(), "chart");
    }
